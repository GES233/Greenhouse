# Copied from
# https://github.com/SynapticStrings/OrchidDehydration/blob/main/lib/orchid/dehydration/hook/hook.ex
# if it works well, implement ets repo and publish it into <hex.pm>.
defmodule Orchid.RunnerHooks.ParamsDehydration do
  @moduledoc """
